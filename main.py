...
BOT_TOKEN  = "8734755865:AAGuig6kNmmMEDk7aVFo6ujpfYl0_lHmRaY"   # @BotFather'dan al
...
PAGE_SIZE  = 8   # bir sayfada kaç buton
...
def build_header(page: int, total_pages: int, total: int) -> str:
    return (
        f"📌 <b>Teminatlı Mswap Üyeleri</b>\n"
        f"Sayfa {page+1}/{total_pages}\n\n"
        f"💡 <b>Renk Anlamları:</b>\n"
        f"• Butonlar → Kullanıcı profiline yönlendirir\n\n"
        f"ℹ️ Teminat eklemek için <code>/tadd @kullanici bilgi</code>\n"
